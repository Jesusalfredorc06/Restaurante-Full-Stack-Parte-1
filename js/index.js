...
function agregarOrden(producto){
    let{pedido} = cliente;
    console.log('pedido',producto.cantidad)
    ...
    const long = cliente.pedido.length;
...
function actualizarResumen(){
    ...
    pedido.forEach(item=>{
        ...
        //console.log(btnEliminar.classList)
...
function eliminarProducto(id){
    ...
    //actualizar la cantidad de producto eliminado a cero
    //console.log(id)
